...
class RFM69 {
  public:
    ...
    virtual bool sendWithRetry(uint8_t toAddress, const void* buffer, uint8_t bufferSize, uint8_t retries=2, unsigned long retryWaitTime=40); // 40ms roundtrip req for 61byte packets
